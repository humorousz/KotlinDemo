...
class Person : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modle.Person) */ {
 public:
  Person();
  virtual ~Person();
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_persion_2eproto_impl();
  friend void  protobuf_AddDesc_persion_2eproto_impl();
